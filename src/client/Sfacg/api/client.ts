...
export class SfacgClient extends SfacgHttp {
    ...
    async authorInfo(authorId: number) {
        try {
            ...
            console.error(
                `GET authorInfos failed: ${JSON.stringify(err.response.data.status.msg)}`
            );
            return false;
        }
    }
    ...
    async volumeInfos(novelId: number): Promise<IvolumeInfos[] | false> {
        try {
            ...
            console.error(
                `GET volumeInfos failed: ${JSON.stringify(err.response.data.status.msg)}`
            );
            return false;
        }
    }
    ...
    async searchInfos(
        ...
        try {
            ...
            console.error(
                `GET searchInfos failed: ${JSON.stringify(err.response.data.status.msg)}`
            );
            return false;
        }
    }
    ...
    // 获取分类主页
    async novels(page: number): Promise<novels[]> {
    ...
    async NewAccountFollowBonus() {
        try {
            ...
            const errMsg = err.response.data.status.msg;
            console.error(`POST NewAccountFollowBonus failed: ${JSON.stringify(errMsg)}`);
            return false;
        }
    }
    ...
    async NewAccountFavBonus() {
        try {
            ...
            const errMsg = err.response.data.status.msg;
            console.error(`POST NewAccountFavBonus failed: ${JSON.stringify(errMsg)}`);
            return false;
        }
    }
